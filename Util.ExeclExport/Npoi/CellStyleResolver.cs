...
using HorizontalAlignment = HwPassion.Util.ExeclExport.Offices.HorizontalAlignment;
using VerticalAlignment = HwPassion.Util.ExeclExport.Offices.VerticalAlignment;

namespace HwPassion.Util.ExeclExport.Npoi {
    /// <summary>
    /// 单元格样式解析器
    /// </summary>
    public class CellStyleResolver {
        ...
        private void SetFillPattern() {
            _result.FillPattern = GetInstance<NPOI.SS.UserModel.FillPattern>(_style.FillPattern);
        }
